...
NewProjectComponent::NewProjectComponent()
{
	...
	FontOptions fOpt(14.80f, juce::Font::plain);

	bpmLabel->setFont(juce::Font(fOpt).withTypefaceStyle("Regular"));
	...
	FontOptions options("Regular",10.0f, Font::plain);
	measuresLabel->setFont(options);
