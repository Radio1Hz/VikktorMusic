...
class OlimInFukushima : CompositionBase
{
public:
	OlimInFukushima()
	{
	...
	void generateContexts(int numMeasures, vector<vector<NoteEventDesc>>& noteEventMatrix, float numQuartersPerMeasure, int numTimeUnitsPerMeasure, int noteRangeStart, int /*noteRangeEnd*/) override
	{
		...
		*/
		...
		vector<ContextDesc> contextsInUse{ ContextDesc(middleC + 10, 1), ContextDesc(middleC + 0, 2), ContextDesc(middleC + 3, 4), ContextDesc(middleC + 3, 4) };
